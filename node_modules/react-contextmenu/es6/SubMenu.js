...
var SubMenu = function (_AbstractMenu) {
    ...
    _createClass(SubMenu, [{
        ...
        value: function render() {
            ...
            var menuItemProps = {
                className: cx(cssClasses.menuItem, (_cx = {}, _defineProperty(_cx, cssClasses.menuItemDisabled, disabled), _defineProperty(_cx, cssClasses.menuItemActive, visible), _defineProperty(_cx, cssClasses.menuItemSelected, selected), _cx)),
