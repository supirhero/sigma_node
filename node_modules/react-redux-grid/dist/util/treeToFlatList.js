...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(treeToFlatList, 'treeToFlatList', 'src/util/treeToFlatList.js');

    __REACT_HOT_LOADER__.register(toItem, 'toItem', 'src/util/treeToFlatList.js');
}();
