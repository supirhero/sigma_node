...
var selectAll = exports.selectAll = function selectAll(_ref3) {
    ...
    var keys = data.currentRecords.map(function (row) {
        return row._key || row.get('_key');
    });
    var indexes = [];

    var selection = keys.reduce(function (obj, k, i) {
        obj[k] = true;
        indexes.push(i);
        return obj;
    }, {});

    return { type: _ActionTypes.SELECT_ALL, selection: selection, stateKey: stateKey, indexes: indexes };
};
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(selectRow, 'selectRow', 'src/actions/plugins/selection/ModelActions.js');

    __REACT_HOT_LOADER__.register(deselectRow, 'deselectRow', 'src/actions/plugins/selection/ModelActions.js');

    __REACT_HOT_LOADER__.register(selectAll, 'selectAll', 'src/actions/plugins/selection/ModelActions.js');

    __REACT_HOT_LOADER__.register(deselectAll, 'deselectAll', 'src/actions/plugins/selection/ModelActions.js');

    __REACT_HOT_LOADER__.register(setSelection, 'setSelection', 'src/actions/plugins/selection/ModelActions.js');
}();
