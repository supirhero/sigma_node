...
var addNewRow = exports.addNewRow = function addNewRow(_ref10) {
    var columns = _ref10.columns,
        ...
        _ref10$rowIndex = _ref10.rowIndex,
        rowIndex = _ref10$rowIndex === undefined ? 0 : _ref10$rowIndex,
        _ref10$isCreate = _ref10.isCreate,
        isCreate = _ref10$isCreate === undefined ? true : _ref10$isCreate;
    return function (dispatch) {
        var rowId = (0, _keyGenerator.keyGenerator)('row', (0, _getNewRowId.getNewRowId)());
        var top = 43;
        var rowData = data || {};

        dispatch({ type: _ActionTypes.ADD_NEW_ROW, stateKey: stateKey, rowId: rowId, rowIndex: rowIndex });
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(editRow, 'editRow', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(repositionEditor, 'repositionEditor', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(dismissEditor, 'dismissEditor', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(updateCellValue, 'updateCellValue', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(saveRow, 'saveRow', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(cancelRow, 'cancelRow', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(removeRow, 'removeRow', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(setEditorValidation, 'setEditorValidation', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(updateRow, 'updateRow', 'src/actions/plugins/editor/EditorActions.js');

    __REACT_HOT_LOADER__.register(addNewRow, 'addNewRow', 'src/actions/plugins/editor/EditorActions.js');
}();
