...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(initialState, 'initialState', 'src/reducers/components/grid.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/reducers/components/grid.js');
}();
