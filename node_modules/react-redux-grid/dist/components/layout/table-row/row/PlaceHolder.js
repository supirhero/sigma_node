...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(PlaceHolder, 'PlaceHolder', 'src/components/layout/table-row/row/PlaceHolder.jsx');

    __REACT_HOT_LOADER__.register(object, 'object', 'src/components/layout/table-row/row/PlaceHolder.jsx');
}();
