...
var Row = exports.Row = function (_Component) {
    ...
    _createClass(Row, [{
        ...
        value: function render() {
            ...
            if ((0, _isPluginEnabled.isPluginEnabled)(plugins, 'ROW') && typeof plugins.ROW.renderer === 'function') {
                ...
                rowEl = plugins.ROW.renderer({ rowProps: rowProps, cells: cells, row: row });
            } else {
                rowEl = _react2.default.createElement(
                    'tr',
                    rowProps,
                    cells
                );
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(bool, 'bool', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(func, 'func', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(object, 'object', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(string, 'string', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(oneOf, 'oneOf', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(number, 'number', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(oneOfType, 'oneOfType', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(DRAG_INCREMENT, 'DRAG_INCREMENT', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(Row, 'Row', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(getCellValues, 'getCellValues', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(addEmptyInsert, 'addEmptyInsert', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(getCellData, 'getCellData', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(addEmptyCells, 'addEmptyCells', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(handleRowDoubleClickEvent, 'handleRowDoubleClickEvent', 'src/components/layout/table-row/Row.jsx');

    __REACT_HOT_LOADER__.register(getSelectedText, 'getSelectedText', 'src/components/layout/table-row/Row.jsx');
    ...
    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/layout/table-row/Row.jsx');
}();
