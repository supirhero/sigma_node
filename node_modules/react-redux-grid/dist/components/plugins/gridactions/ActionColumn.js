...
var ActionColumn = exports.ActionColumn = function (_Component) {
    ...
    _createClass(ActionColumn, [{
        ...
        value: function render() {
            ...
            var containerProps = {
                className: (0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.CONTAINER, menuShown ? CLASS_NAMES.GRID_ACTIONS.SELECTED_CLASS : '', menuPosition !== undefined ? menuPosition : ''),
...
ActionColumn.propTypes = {
    ...
    headerActionItemBuilder: _propTypes2.default.func,
    iconCls: _propTypes2.default.string,
    menuState: _propTypes2.default.object,
...
var enableActions = exports.enableActions = function enableActions(menuShown, actions, columns, rowData) {
    ...
    if (menuShown && actions && typeof actions.onMenuShow === 'function') {
        ...
        var val = rowData && rowData.toJS ? rowData.toJS() : rowData;
...
var getColumn = exports.getColumn = function getColumn(cols, containerProps, iconProps, menuShown, actions, columns, store, editor, reducerKeys, rowId, rowData, rowIndex, stateKey, stateful, headerActionItemBuilder, maxHeight) {
    ...
    if (actions && actions.menu && actions.menu.length === 0) {
        iconProps.className += ' ' + (0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.NO_ACTIONS);
    }
...
var handleHideMenu = exports.handleHideMenu = function handleHideMenu(stateKey, store, initialTarget, reducerKeys, e) {
    ...
    var occurredInHeader = (0, _elementContains.elementContains)(e.target, (0, _prefix.prefix)(CLASS_NAMES.HEADER));

    var isHeaderMenu = occurredInHeader && e.target.classList.contains((0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.ICON));

    var isHeaderAction = occurredInHeader && (0, _elementContains.elementContains)(e.target, (0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.MENU.CONTAINER));

    var isRowAction = (0, _elementContains.elementContains)(e.target, (0, _prefix.prefix)(CLASS_NAMES.ROW)) && e.target.classList.contains((0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.ICON));

    var isSameNode = initialTarget === e.target && !(0, _elementContains.elementContains)(e.target, (0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.MENU.CONTAINER));

    var isActionMenu = isSameNode && (0, _elementContains.elementContains)(e.target, (0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.MENU.CONTAINER));
    ...
    var actionDisabled = e.target && e.target.classList.contains((0, _prefix.prefix)(CLASS_NAMES.GRID_ACTIONS.DISABLED));
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(ActionColumn, 'ActionColumn', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(removeableEvent, 'removeableEvent', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(enableActions, 'enableActions', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(getHeader, 'getHeader', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(addKeysToActions, 'addKeysToActions', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(getColumn, 'getColumn', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(handleHideMenu, 'handleHideMenu', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(handleActionClick, 'handleActionClick', 'src/components/plugins/gridactions/ActionColumn.jsx');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/plugins/gridactions/ActionColumn.jsx');
}();
