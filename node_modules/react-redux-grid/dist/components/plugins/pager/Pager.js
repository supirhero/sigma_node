...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(PagerToolbar, 'PagerToolbar', 'src/components/plugins/pager/Pager.jsx');

    __REACT_HOT_LOADER__.register(getCustomComponent, 'getCustomComponent', 'src/components/plugins/pager/Pager.jsx');

    __REACT_HOT_LOADER__.register(getCurrentRecordTotal, 'getCurrentRecordTotal', 'src/components/plugins/pager/Pager.jsx');

    __REACT_HOT_LOADER__.register(getTotal, 'getTotal', 'src/components/plugins/pager/Pager.jsx');

    __REACT_HOT_LOADER__.register(getPager, 'getPager', 'src/components/plugins/pager/Pager.jsx');

    __REACT_HOT_LOADER__.register(getPagingSource, 'getPagingSource', 'src/components/plugins/pager/Pager.jsx');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/plugins/pager/Pager.jsx');
}();
