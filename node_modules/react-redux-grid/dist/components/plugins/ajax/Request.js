...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(api, 'api', 'src/components/plugins/ajax/Request.js');

    __REACT_HOT_LOADER__.register(setRequestHeaders, 'setRequestHeaders', 'src/components/plugins/ajax/Request.js');

    __REACT_HOT_LOADER__.register(addAjaxEvents, 'addAjaxEvents', 'src/components/plugins/ajax/Request.js');

    __REACT_HOT_LOADER__.register(buildQueryString, 'buildQueryString', 'src/components/plugins/ajax/Request.js');

    __REACT_HOT_LOADER__.register(Request, 'Request', 'src/components/plugins/ajax/Request.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/plugins/ajax/Request.js');
}();
