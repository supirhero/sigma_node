...
var Grid = exports.Grid = function (_Component) {
    ...
    _createClass(Grid, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_FixedHeader2.default, this.getHeaderProps(true)),
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (this._USING_DATA_ARRAY) {
                var shouldResetData = !(0, _deepEqual2.default)(this.props.data, nextProps.data);
    ...
    _createClass(Grid, [{
        ...
        value: function __getEditor__REACT_HOT_LOADER__() {
            return this.editor.getComponent(this.props.plugins, this.props.reducerKeys, this.props.store, this.props.events, this.selectionModel, this.editor, this.props.columns);
        }
    }, {
