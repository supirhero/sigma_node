...
var ColumnManager = function () {
    ...
    _createClass(ColumnManager, [{
        ...
        value: function doSort(_ref2) {
            ...
            var pageSize = pagerState && pagerState.get('pageSize') ? pagerState.get('pageSize') : _GridConstants.DEFAULT_PAGE_SIZE;

            var beforeSortEvent = (0, _fire.fireEvent)('HANDLE_BEFORE_SORT', this.events, {
                property: propName,
                direction: direction,
                store: this.store,
                column: column
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(ColumnManager, 'ColumnManager', 'src/components/core/ColumnManager.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/core/ColumnManager.js');
}();
