...
function enhanceDataTable(ComposedComponent) {
  ...
  return _temp = _class = function (_Component) {
    ...
    function DataTableEnhancer(props) {
      ...
      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DataTableEnhancer).call(this, props));

      _this.onPageNumberChange = function (value) {
        _this.setState(function (state) {
          return (0, _dataReducer2.default)(state, (0, _actions.pageNumberChange)(value));
        });
      };
      ...
      _this.onPageSizeChange = function (_ref) {
        ...
        _this.setState(function (state) {
          return (0, _dataReducer2.default)(state, (0, _actions.pageSizeChange)(value));
        });
      };

      _this.onSort = function (value) {
        _this.setState(function (state) {
          return (0, _dataReducer2.default)(state, (0, _actions.dataSort)(value));
        });
      };
      ...
      _this.onFilter = function (key, _ref2) {
        ...
        _this.setState(function (state) {
          return (0, _dataReducer2.default)(state, (0, _actions.dataFilter)(key, value, _this.props.filters));
        });
      };

      _this.state = (0, _dataReducer2.default)(mapPropsToState(props), (0, _actions.dataLoaded)(props.initialData));
      return _this;
    }
    ...
    _createClass(DataTableEnhancer, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        this.setState(function (state) {
          return (0, _dataReducer2.default)(state, (0, _actions.dataLoaded)(nextProps.initialData));
        });
      }
    }, {
      key: 'render',
