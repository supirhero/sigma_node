...
class EditProject extends Component {
  ...
  render() {
    ...
    return (!this.state.loaded && !this.props.state.data.overview ? < PageLoader / > :
      <
      div >
      ...
      ProjectHeader projectName = {
        this.props.state.data.overview.project_name
      }
      sectionName = "EDIT PROJECT" / >
      ...
      component = {
        iwo_no != 'NONE' ? ReduxInputDisabled : ReduxInput
      }
      /> <
      Field inputName = "BUSINESS UNIT"
      name = "BU"
      type = "BU"
      style = {
        {
      ...
      /> <
      Field inputName = "RELATED BUSINESS UNIT"
      name = "RELATED"
      type = "RELATED"
      style = {
        {
      ...
      div className = "unit whole" >
      <
      Field inputName = "PROJECT MANAGER"
      name = "PM"
      style = {
        {
          width: '96%'
      ...
      div className = "unit whole" >
      <
      Field inputName = "TYPE OF EFFORT"
      name = "TYPE_OF_EFFORT"
      style = {
        {
          width: '96%'
      ...
      option > < /option> {
        this.props.formValues &&
          ...
          <
          option value = '8' { ...this.props.option
          } > Non Project < /option>
      ...
      div className = "unit whole" >
      <
      Field inputName = "ACCOUNT MANAGER"
      name = "AM_ID"
      style = {
        {
          width: '96%',
      ...
      div className = "unit whole" >
      <
      Field inputName = "PROJECT STATUS"
      name = "PROJECT_STATUS"
      style = {
        {
          width: '100%'
