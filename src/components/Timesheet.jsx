...
class Timesheet extends Component {
  ...
  render() {
      ...
      //  }
      return (!timesheet.user_project ? < PageLoader > < /PageLoader> : <
          div >
          <
          ...
          <
          span className = "icon-arrow-left-circle list-pointer"
          onClick = {
            e => {
              this.setState({
          ...
          div style = {
            ...
            state.data.weekdays ? state.data.weekdays.map((value, index) => {
              return <TimeSheetTimeButton text = {
                moment(value.day).format("ddd, MMM D")
              }
              hours = {
                value.holiday == false ? `${value.work_hour} Hours` : "Day Off"
              }
              onClick = {
                e => {
          ...
          span className = "icon-arrow-right-circle list-pointer"
          onClick = {
            e => {
              this.setState({
                jumlah: this.state.jumlah - 1
          ...
          <
          /button> <
          PopUp id = "addNewTimesheet"
          dividerText = "INPUT TIMESHEET"
          btnClass = "btn-primary"
          btnText = "INPUT TIMESHEET"
          btnStyle = {
            {
              display: 'block',
              margin: 'auto'
...

  {
    ...
    small > {
      auth.userdata.profile_name
    }, {
      auth.userdata.position
    } < /small> < /
    div > <
      /div> < /
    div > {
            ...
            return ( <
              ...
              p > ( < b > {
                ...
                small style = {
                  ...
                  value.SUBMIT_DATE ? `submitted on : ${moment((value.SUBMIT_DATE).substr(0,9)).format('DD-MMM-YYYY')} | ${(value.SUBMIT_DATE).substr(10,5)} ${(value.SUBMIT_DATE).substr(26,2)}` : null
                } < /small> <
                br / >
                <
                br / >
                ...
                small style = {
                  ...
                  value.TS_DATE ? `submitted for : ${moment(value.TS_DATE).format('DD-MMM-YYYY')}` : null
                } < /small>  < /
                small > <
                div className = "grid wrap"
                style = {
        ...
        div >: <
          ...
          } > < b > Enjoy your day - off!! < br / > You don 't have to update anything today</b></large> < /
        div > <
        div className = "unit whole"
        style = {
          {
