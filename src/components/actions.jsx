...
export function pop(page) {
  const currentPage = store.getState().data.page
    ? store.getState().data.page.name
    : null;
  return {
    type: "POP",
...
export const getBusinessUnitDetail = (
  id,
  STATUS,
  PROJECT_TYPE,
  EFFORT_TYPE,
...
export const reportSearchProject = (
  status,
  schedule,
  budget,
  keyword,
